...
> check below passed on production's own data — results in RLS-4 of the retired board
> (`git log -p -- tickets/ENVIRONMENTS_AND_RLS_TICKETS.md`). **Not yet run on production itself.**
...
> on 2026-09-13** — results in RLS-4 of the retired board
