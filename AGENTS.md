...
### Quick Reference (Codex-optimized)
| Document | Contents |
|----------|----------|
| [Schema Reference](./docs/Codex/SCHEMA.md) | All 80+ database tables with columns |
| [API Endpoints](./docs/Codex/API_ENDPOINTS.md) | All API routes organized by domain |
| [Services Reference](./docs/Codex/SERVICES.md) | 90+ service classes by domain |
| [Frontend Pages](./docs/Codex/PAGES.md) | 30+ pages with routes and features |
| [Features & Security](./docs/Codex/FEATURES.md) | Feature status, security, changelog |
