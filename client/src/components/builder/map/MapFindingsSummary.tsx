 ...
 * AC5: a finding whose `target.pageId` matches no node on the map must
...
export function MapFindingsSummary({ counts }: MapFindingsSummaryProps) {
  ...
  return (
    <div
      ...
      className="flex flex-wrap items-center gap-x-4 gap-y-1 border-b bg-[var(--map-page-bg)] px-4 py-1.5 text-xs"
    >
      {counts.errors > 0 && (
