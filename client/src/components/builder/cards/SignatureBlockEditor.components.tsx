...
export type UpdateHandler = (updates: Partial<SignatureBlockConfig>) => void;

export const SignerSection = ({ config, onUpdate }: { config: SignatureBlockConfig; onUpdate: UpdateHandler }) => {
...
export const ProviderSection = ({ config, onUpdate }: { config: SignatureBlockConfig; onUpdate: UpdateHandler }) => (
    <div className="space-y-3">
...
export const DocumentsSection = ({ config, onUpdate }: { config: SignatureBlockConfig; onUpdate: UpdateHandler }) => {
...
export const AdvancedSection = ({ config, onUpdate }: { config: SignatureBlockConfig; onUpdate: UpdateHandler }) => (
    <div className="space-y-3">
        <SectionHeader
